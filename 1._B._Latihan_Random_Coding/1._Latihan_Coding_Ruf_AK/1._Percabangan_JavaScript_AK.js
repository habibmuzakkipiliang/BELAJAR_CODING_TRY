...
console.log ("\n Fungsi dengan Percabangan Nested, Majemuk Kompleks, usia nonton film Horor Kamu Pantas Mati \n")

function horor (usia, uang) {
     
     if (usia >= 17 && uang >= 100000) {
          if (cek == true) {
                 console.log (`Kamu boleh nonton film horor, usia = ${usia}, uang = ${uang}`)
          }

          else if (usia >= 17 && uang <= 100000) {
                 console.log (`Kamu boleh nonton film horor, tapi uang kamu kurang, usia = ${usia}, uang = ${uang}`)
          }

          else {
               console.log (`Belum cukup umur, kamu tidak boleh nonton film horor, usia = ${usia}, uang = ${uang}`)
          }
     }

     else {
          console.log (`Lain kali aja nontonnya, usia = ${usia}, uang = ${uang}`)
     }
}
