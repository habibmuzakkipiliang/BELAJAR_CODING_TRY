...
nama = "Nabi Muhammad (Ahmad)"
hari_lahir = "Hari Subuh Senin"
tanggal_lahir = "12 Rabbiul Awal / Tahun Gajah / 20 April 571 Masehi"
ayah = "Abdullah"
ibu = "Aminah"
kakek = "Abdul Muthalib"
masa_kecil = "Penggembala"
masa_remaja = "Pedagang"
status = "Yatim Piatu"


print ("Nama :", nama)
print ("Hari Lahir :", hari_lahir)
print ("Tanggal lahir :", tanggal_lahir)
print ("Nama Ayah :", ayah)
print ("Nama Ibu :", ibu)
print ("Nama kakek :", kakek)
print ("Masa kecil :", masa_kecil)
print ("Masa remaja :", masa_remaja)
print ("Status :", status)
