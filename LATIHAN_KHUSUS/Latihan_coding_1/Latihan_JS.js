...
var daf = ["Halo Dunia", "Halo Fun", "Halo Sun", "Halo Dust"]

for (f = 0; f < daf.length; f++) {
     console.log (daf [f])
}
...
var hun = ["Halo Ao Bing", "Halo Ne Zha", "Halo Voltra", "Halo Shen Gongbao"]

for (i = 0; i < hun.length; i++) {
     console.log (hun [i])
}
...
var fun = ["Halo Kun", "Halo Naruto", "Halo Dunf", "Halo Gael", "Halo Gone"]

fun.push ("Halo Dunua")
fun.push ("Hello Yellow")
fun.push ("Hello Fun")
fun.push ("Hello Far")
...
var fur = ["Red", "Black", "white", "Blue", "Gray", "Yellow"]

for (j = 0; j < fur.length; j++) {
     console.log (fur [j])
}
