...
def horor (uang, usia):
     ...
     if usia >= 17 and uang >= 100000:
          if cek == True:
               print (f"Kamu boleh nonton film horor, usia = {usia}, uang = {uang}")
               
          elif usia >= 17 and uang <= 100000:
               print (f"Kamu boleh nonton film horor, tapi uang kamu kurang, usia = {usia}, uang = {uang}")
               
          else:
               print (f"Belum cukup umur, kamu tidak boleh nonton film horor, usia = {usia}, uang = {uang}")
               
     else:
          print (f"Lain kali aja nontonnya, usia = {usia}, uang = {uang}")
